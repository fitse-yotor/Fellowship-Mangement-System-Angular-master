...
@Component({
    selector: 'app-post-graduates-groups-modal',
    templateUrl: './post-graduates-groups-modal.component.html',
    styleUrls: ['./post-graduates-groups-modal.component.scss']
})
export class PostGraduatesGroupsModalComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<PostGraduatesGroupsModalComponent>,
