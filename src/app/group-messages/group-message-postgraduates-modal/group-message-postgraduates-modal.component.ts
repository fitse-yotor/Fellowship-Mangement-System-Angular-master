...
@Component({
  selector: 'app-group-message-postgraduates-modal',
  templateUrl: './group-message-postgraduates-modal.component.html',
  styleUrls: ['./group-message-postgraduates-modal.component.scss']
})
export class GroupMessagePostgraduatesModalComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<GroupMessagePostgraduatesModalComponent>,
    ...
    groupmessagesModal(groupmessagesModalInterface: GroupMessagesModalInterface) {
        ...
        // .append('Authorization', 'Bearer ' + this.storageService.getStorage('accessToken'));
        return this.groupedMessageService.create(groupmessagesModalInterface, headers, '/post-graduate-team-message')
